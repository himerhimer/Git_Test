...
#define RS_GPIO_PIN		  	GPIO_Pin_0			        /* 连接到SCL时钟线的GPIO */

#define RW_GPIO_PORT    	GPIOB			              /* GPIO端口 */
#define RW_GPIO_CLK 	    RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define RW_GPIO_PIN		  	GPIO_Pin_1			        /* 连接到SCL时钟线的GPIO */

#define E_GPIO_PORT    		GPIOB			              /* GPIO端口 */
#define E_GPIO_CLK 	    	RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define E_GPIO_PIN		  	GPIO_Pin_5			        /* 连接到SCL时钟线的GPIO */

#define CSA_GPIO_PORT    		GPIOB			              /* GPIO端口 */
#define CSA_GPIO_CLK 	    	RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define CSA_GPIO_PIN		  	GPIO_Pin_5			        /* 连接到SCL时钟线的GPIO */

#define CSB_GPIO_PORT    		GPIOB			              /* GPIO端口 */
#define CSB_GPIO_CLK 	    	RCC_APB2Periph_GPIOB		/* GPIO端口时钟 */
#define CSB_GPIO_PIN		  	GPIO_Pin_5			        /* 连接到SCL时钟线的GPIO */
